...
final class GameTemporaryDataBase {
    ...
    var gameQuestions = [
        ...
        Question.init(question: "Какой валовый внутренний продукт Ливана?", answer: [.init(text: "38 млн.$", correct: false), .init(text: "52 млрд.$", correct: true), .init(text: "Какого Ливана?", correct: false), .init(text: "134 млрд. рублей", correct: false)]),
    ]
